...
See [`docs/store_sales_project.md`](docs/store_sales_project.md) for the full project reference: dataset API, feature flags, model lineup, MLflow setup, and run commands.

**If you notice a discrepancy between that doc and the code, update the doc.**
